function y = eightday_gpp(expcase,data)
% case1:2001-2009 
% case2:2010-2015
% case3:2001-2015
ii = 1; %GPP
...
if expcase == 2
    ...
    y = [eightday10;eightday11;eightday12;eightday13;eightday14;eightday15];
end
if expcase == 3
    y = [eightday01;eightday02;eightday03;eightday04;eightday05;eightday06;eightday07;eightday08;eightday09;...
        eightday10;eightday11;eightday12;eightday13;eightday14;eightday15];
end
...
function result = f(gppdata)
    ...
    for i = 1:8:361   
        if (i<361)
            eightday(i-7*j,1) = sum(gppdata(i:i+7,1));
        else
            eightday(i-7*j,1) = sum(gppdata(i:length(gppdata),1));
        end
        j = j+1;
    end    
    result = eightday;
