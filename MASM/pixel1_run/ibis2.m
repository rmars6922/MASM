function [gla_lai_total gla_gpp_total LAI_model_8d_total GPP_model_8d_total NEE_model] = ibis(x,expcase)
%expcase = 1;
...
% calculate likelihood
    y_sim = LAI_model_8d_total; 
    y_obs = gla_lai_total;    
    f_1 = (norm(y_sim-y_obs))^2;
    var1 = var(y_obs);
    f1 = f_1/var1;
    
    y_sim2 = GPP_model_8d_total; 
    y_obs2 = gla_gpp_total;    
    f_2 = (norm(y_sim2-y_obs2))^2;
    var2 = var(y_obs2);
    f2 = f_2/var2;
