...
c
        tgpp(i,1)  = frac(i,1)  * ancub(i) * lai(i,2) * fu(i)
        tgpp(i,2)  = frac(i,2)  * ancub(i) * lai(i,2) * fu(i)
        tgpp(i,3)  = frac(i,3)  * ancub(i) * lai(i,2) * fu(i)
        tgpp(i,4)  = frac(i,4)  * ancuc(i) * lai(i,2) * fu(i)
        tgpp(i,5)  = frac(i,5)  * ancub(i) * lai(i,2) * fu(i)
        tgpp(i,6)  = frac(i,6)  * ancuc(i) * lai(i,2) * fu(i)
        tgpp(i,7)  = frac(i,7)  * ancub(i) * lai(i,2) * fu(i)
        tgpp(i,8)  = frac(i,8)  * ancub(i) * lai(i,2) * fu(i)
        tgpp(i,9)  = frac(i,9)  * ancls(i) * lai(i,1) * fl(i) * smask 
        tgpp(i,10) = frac(i,10) * ancls(i) * lai(i,1) * fl(i) * smask
        tgpp(i,11) = frac(i,11) * ancl4(i) * lai(i,1) * fl(i) * smask
        tgpp(i,12) = frac(i,12) * ancl3(i) * lai(i,1) * fl(i) * smask
c
