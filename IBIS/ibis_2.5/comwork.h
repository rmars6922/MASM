c
c -------
c comwork  include file  last update 3/23/01 D.Polzin
c -------
c
...
c
      ...
      real OCEAN
c
      maxdim4 = max(nlon,nlat,nband,nsoilay,nsnolay,npft)
      parameter ( OCEAN=9.e+20 ) ! the value to use for non-land points
      parameter  ndim2 = nlon*nlat
      parameter  ndim4 = maxdim4
      parameter  ndim3 = nlon*nlat*maxdim4
c
