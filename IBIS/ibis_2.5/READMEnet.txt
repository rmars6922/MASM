READMEnet.txt last update 3/15/01 (Dierk Polzin)
...
www.unitadata.ucar.edu) compiled with the FORTRAN option turned on.
...
-------------------  ------------  -------------  -------------
input/surta.sand.nc  always        surta          level
input/surta.clay.nc  always        surta          level
input/topo.nc        always        topo           level
input/vegtype.nc     isimveg <= 1  vegtype        level
input/deltat.nc      always        deltat         level
input/soita.nc       always        tex            layer
...
input/rhum.mon.nc    always        rhum           level
